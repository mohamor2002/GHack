...
const ProjectCard = ({title , difficulty , keywords}) => {
  return (
    <div className=' p-8 m-5 bg-white w-[100%]'>
      ...
      <BookmarksOutlinedIcon  />
       ...
       <h1 className='text-main-blue mb-3 font-bold text-3xl bg-white'>{title}</h1>
       <h3 className='mb-1 text-xl font-semibold'>Difficulty</h3>
       <h2 className='font-semibold text-xl text-main-green mb-5'>{difficulty}</h2>
